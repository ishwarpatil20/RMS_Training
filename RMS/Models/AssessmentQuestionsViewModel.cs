...
namespace RMS.Models
{
    public class AssessmentQuestionsViewModel
    {
        ...
        public HttpPostedFileBase QuestionImg { get; set; }
        ...
        public HttpPostedFileBase Option5Image { get; set; }
        ...
        public HttpPostedFileBase Option6Image { get; set; }
        ...
        public bool IsDisplaySelect { get; set; }

        public bool IsAddQuestion { get; set; }

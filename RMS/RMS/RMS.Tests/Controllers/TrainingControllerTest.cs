...
//
//  File:           TrainingControllerTest.cs       
//  Author:         jagmohan.rawat
//  Date written:   13/07/2015/ 10:58:30 AM
//  Description:    TrainingControllerTest page is use for testing Training controller actions.
//
//  Amendments
...
namespace RMS.Tests.Controllers
{
    ...
    public class TrainingControllerTest
    {
        private readonly ITrainingModel _service;
            ...
            public TrainingControllerTest(ITrainingModel service)
            {            
                _service = service;
            }

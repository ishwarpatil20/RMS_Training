...
namespace RMS.Common.Constants
{
    public static class SPNames
    {
        ...
        public const string TNI_ViewSoftSkillsTraining = "USP_TNI_ViewSoftSkillsTraining_Update";
        public const string TNI_DeleteSoftSkillsTraining = "USP_TNI_DeleteSoftSkillsTraining";
        public const string TNI_ViewKSSTraining = "USP_TNI_ViewKSSTraining_Update";
        public const string TNI_ViewSeminarsTraining = "USP_TNI_ViewSeminarsTraining_Update";
        ...
        public const string USP_RPL_CheckUserAccess = "USP_RPL_CheckUserAccess";        

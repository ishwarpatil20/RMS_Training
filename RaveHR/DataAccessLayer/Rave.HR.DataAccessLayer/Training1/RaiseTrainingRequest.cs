...
namespace Rave.HR.DataAccessLayer.Training
{
    public class RaiseTrainingRequest
    {
        ...
        int TechnicalTrainingID = 1191;
        int SoftSkillsTrainingID = 1192;
        DataSet ds;
        ...
        public BusinessEntities.RaiseTrainingRequest GetTechnicalSoftSkills(int RaiseID, int TrainingTypeID)
        {
            ...
            try
            {
                ...
                ds = new DataSet();
                if (TrainingTypeID == TechnicalTrainingID)
                {
                    ds = objGetTechnicalTraining.GetDataSet(SPNames.TNI_GetTechnicalTraining, sqlParam);
                }
                else if (TrainingTypeID == SoftSkillsTrainingID)
                {
        ...
        public int DeleteTechnicalSoftSkillsTraining(BusinessEntities.RaiseTrainingRequest RaiseTraining, int TrainingTypeID)
        {
            SqlConnection objConnection = null;
            SqlCommand objCommand = null;
            string ConnStr = string.Empty;
            try
            {
                ...
                if (TrainingTypeID == TechnicalTrainingID)
                {
                    sqlParam[3] = objCommand.Parameters.AddWithValue(SPParameter.OutTechnicalID, 0);
                    sqlParam[3].Direction = ParameterDirection.Output;
                }
                else if (TrainingTypeID == SoftSkillsTrainingID)
                {
                    sqlParam[3] = objCommand.Parameters.AddWithValue(SPParameter.OutSoftSkillsID, 0);
                    sqlParam[3].Direction = ParameterDirection.Output;
                }

                int Raise = objCommand.ExecuteNonQuery();
                int RaiseTechnicalID = Convert.ToInt32(sqlParam[3].Value);

                return RaiseTechnicalID;
            }
            catch (Exception ex)
            {
        ...
        public int DeleteKSSTraining(BusinessEntities.RaiseTrainingRequest RaiseTraining)
        {
            SqlConnection objConnection = null;
            SqlCommand objCommand = null;
            string ConnStr = string.Empty;
            try
            {
                ...
                sqlParam[1] = objCommand.Parameters.AddWithValue(SPParameter.Status, RaiseTraining.Status);
                sqlParam[2] = objCommand.Parameters.AddWithValue(SPParameter.UserEmpID, RaiseTraining.UserEmpId);
                sqlParam[3] = objCommand.Parameters.AddWithValue(SPParameter.OutKSSID, 0);
                sqlParam[3].Direction = ParameterDirection.Output;

                int Raise = objCommand.ExecuteNonQuery();
                int RaiseKSSID = Convert.ToInt32(sqlParam[3].Value);
        ...
        public int DeleteSeminarsTraining(BusinessEntities.RaiseTrainingRequest RaiseTraining)
        {
            SqlConnection objConnection = null;
            SqlCommand objCommand = null;
            string ConnStr = string.Empty;
            try
            {
                ...
                sqlParam[1] = objCommand.Parameters.AddWithValue(SPParameter.Status, RaiseTraining.Status);
                sqlParam[2] = objCommand.Parameters.AddWithValue(SPParameter.UserEmpID, RaiseTraining.UserEmpId);
                sqlParam[3] = objCommand.Parameters.AddWithValue(SPParameter.OutSeminarsID, 0);
                sqlParam[3].Direction = ParameterDirection.Output;

                int Raise = objCommand.ExecuteNonQuery();
                int RaiseSeminarsID = Convert.ToInt32(sqlParam[3].Value);

                return RaiseSeminarsID;
            }
            catch (Exception ex)
            {
        ...
        public BusinessEntities.RaveHRCollection ViewKSSTraining(BusinessEntities.RaiseTrainingRequest RaiseTraining, BusinessEntities.ParameterCriteria objParameter, ref int pageCount)
        {
            ...
            try
            {
                ...
                DataSet ds = objGetTraining.GetDataSet(SPNames.TNI_ViewKSSTraining, sqlParam);
        ...
        public int SaveApproveRejectTrainingRequest(BusinessEntities.RaiseTrainingRequest RaiseTraining)
        {
            ...
            try
            {
                ...
                int Raise = objCommand.ExecuteNonQuery();
                int RaiseKSSID = Convert.ToInt32(sqlParam[4].Value);
        ...
        /// </summary>
        /// <returns>Collection</returns>
        public DataTable GetEditKSSTrainingGroup(int UserEmpID)
        {
            DataAccessClass objGetTraining = new DataAccessClass();
            SqlParameter[] sqlParam = new SqlParameter[1];
            raveHRCollection = new BusinessEntities.RaveHRCollection();
        ...
        public int AccessForTrainingModule(int UserEmpId)
        {
            ...
            try
            {
                ...
                int Trainingid = objCommand.ExecuteNonQuery();

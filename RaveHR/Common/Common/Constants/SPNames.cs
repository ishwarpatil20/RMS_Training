...
//
//  File:           SPNames.cs       
//  Author:         Kanchan Paranjape
//  Date written:   25/06/2009/ 12:05:40 PM
//  Description:    This class provides SP Name constants
//                  
//
//  Amendments
//  Date                    Who                 Ref     Description
//  ----------------------  -----------         ---     -----------
//  25/06/2009 12:05:40 PM  Kanchan Paranjape   n/a     Created   
//  17/08/2009 01:51:02 PM  Vineet Kulkarni     n/a     Added SP Names for Employee Module
//
//------------------------------------------------------------------------------
...
{
    /// <summary>
    /// Define all the names of stored procedures that are commonly used by Data Access Layer for Projects Module.
    /// </summary>
    public static class SPNames
    {
        ...
        public const string Employee_Employee_GetEmployeeDomain = "USP_Employee_GetEmployeeDomain";

        //Rakesh : HOD for Employees 11/07/2016 Begin   
        public const string Employee_GetHeadOfDepartments = "USP_GET_HeadOfDepartments";
        //Rakesh : HOD for Employees 11/07/2016 End   

        public const string Employee_UpdateEmployeeDomain = "USP_Employee_UpdateEmployeeDomain";
        public const string Insert_T_Master = "USP_Insert_T_Master";
        public const string CheckSkillCategory = "USP_Employee_CheckSkillCategory";
        //Siddhesh Arekar Domain Details 10082015 End

        public const string GetEmployeeBusinessVertical = "USP_GetEmployeeBusinessVertical";

        //Rakesh : Business Vertical Wise Resume Template Download 08/07/2016 
        public const string GetEmployeeBusinessVerticalID = "USP_GetEmployeeBusinessVerticalID";


        
        public const string CheckEmployeeIsProjectManager = "USP_CheckEmployeeIsProjectManager";
        ...
        public const string MRF_IS_NIS_NORTHGATE = "USP_MRF_IsNIS_Project";
        //End
        ...
        public const string GET_4C_GetActionDetailsHighlightForDashboard = "USP_4C_GetActionDetailsHighlightForDashboard";
        //Ishwar 25082015 End

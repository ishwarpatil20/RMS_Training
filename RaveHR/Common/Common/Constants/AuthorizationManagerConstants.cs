...
//
//  File:           AuthorizationManagerConstants.cs       
//  Author:         Prashant Mala
//  Date written:   28/04/2009/ 5:32:30 PM
//  Description:    This class  provides constants for authorization of user.
//                  
//
//  Amendments
...
{
    /// <summary>
    /// Define all the constants that are commonly used by AuthorizationManager components.
    /// </summary>
    public static class AuthorizationManagerConstants
    {
        ...
        /// </summary>
        public const string NORTHGATEDOMAINEMAIL = "northgateps.com";

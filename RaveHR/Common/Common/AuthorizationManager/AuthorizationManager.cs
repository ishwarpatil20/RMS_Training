...
//  Description:    This class provides the methods for authorization of user.
//                  
//
//  Amendments
...
//  26/08/2009 1:04:30 PM  Prashant Mala    n/a     Add new method getLoggedInUserEmailId      
//------------------------------------------------------------------------------
...
namespace Common.AuthorizationManager
{
    public class AuthorizationManager
    {
        ...
        public string getLoggedInUser()
        {
            ...
            //string strUserIdentity = @"northgate-is.co.in\mahendra.bharambe";
            //GoogleMail
            try
            {
        ...
        public void AuthorizeUserForPageView(object[] operationsId)
        {
            ...
            try
            {
                ...
                if (!bCheckAccess)
                {
                    HttpContext.Current.Response.Redirect(Common.CommonConstants.UNAUTHORISEDUSER, false);
                }
            }
            catch (RaveHRException ex)
            {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeesEmailList.aspx.cs"
    Inherits="EmployeesEmailList" %>
                            ...
                            <asp:GridView ID="grvEmployeeEmail" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" HeaderText="Select">
                                        <ItemTemplate>
                                            <input type='radio' name="rbEmailList" value='<%# Eval("EmailID") %>' />
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="EmailID" HeaderText="Employee EmailID" SortExpression="EMPCode">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="45%" HorizontalAlign="center" />
                                    </asp:BoundField>
                                </Columns>

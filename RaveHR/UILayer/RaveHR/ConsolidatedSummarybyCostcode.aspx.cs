...
public partial class ConsolidatedSummarybyCostcode : BaseClass
{
    ...
    private void GetConsolidated(string SortExpressionAndDirection)
    {
        ...
        try
        {
            ...
            ds = employeeBL.GetConsolidatedByCostCode(ddlProject.SelectedValue, SortExpressionAndDirection);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            gvList = new GridView[] { GVResourcesOnboard };
            //gvList = new GridView[] { GVResourcesOnboard, GVResourcesReleased };
            ExportAv("Consolidated Report By CostCode.xls", gvList);
        }
        catch (Exception ex)
        {
